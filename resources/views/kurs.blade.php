...
@section('title', 'Foreign Exchange Rates')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="enail" class="form-control" name="value" id="value" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="name">Selling Rate :</label>
                    <input type="text" class="form-control" name="selling_rate" id="selling_rate">
                </div>
                <div class="form-group">
                    <label for="name">Buying Rate :</label>
                    <input type="text" class="form-control" name="buying_rate" id="buying_rate">
                </div>
...
// Create company Ajax request.
        $('#SubmitCreateUserForm').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('kurs.store') }}",
                method: 'post',
                data: {
                    currency: $('#currency').val(),
                    value: $('#value').val(),
                    selling_rate: $('#selling_rate').val(),
                    buying_rate: $('#buying_rate').val(),
                },
